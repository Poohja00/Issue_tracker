<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <body>
            <div align="center">
                <h2>Admin Login</h2>
                <form:form action="loginasadmin" method="post" modelAttribute="login">

                    <div>
                        <form:label path="admin" placeholder="Enter your ID">Admin ID:</form:label>
                    ...
                    <div>
                        <form:label path="password" placeholder="Enter your password">Password:</form:label>
